...
train_path = os.path.join(base_dir, "desktop/smart_ads/data/03_3_feature_selection_text_code6/train.csv")
val_path = os.path.join(base_dir, "desktop/smart_ads/data/03_3_feature_selection_text_code6/validation.csv")
