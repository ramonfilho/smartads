...
train_path = os.path.join(base_dir, "desktop/smart_ads/data/02_processed_text_v2/train.csv")
val_path = os.path.join(base_dir, "desktop/smart_ads/data/02_processed_text_v2/validation.csv")
