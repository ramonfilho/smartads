...
# Modificar inference_05_gmm_predict.py para usar caminhos relativos
CALIBRATED_MODEL_DIR = os.path.join(project_root, "models/calibrated/gmm_calibrated_20250518_152543")
...
GMM_COMPONENTS_DIR = os.path.join(project_root, "models/artifacts/gmm_optimized")
